    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center max-w-sm mx-auto px-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">KPI Tracker</h1>
          <p className="text-gray-500 mb-8">Track your personal goals and habits. Sync across all your devices.</p>
          <button
            onClick={signIn}
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-xl px-6 py-3 text-gray-700 font-medium shadow-sm hover:shadow-md transition-shadow"
          >
